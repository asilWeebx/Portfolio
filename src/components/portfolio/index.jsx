...
function Portfolio() {
    const projects = [
       {
    id: 1,
    title: 'ImranToys POS System – Inventory & Sales Management Platform',
...
{
    id: 2,
    title: 'Devnity – Software Development & Service Platform',
...
{
    id: 3,
    title: 'Level-Up Student App – Education & Progress Tracking System',
    image: portfolioImage1,
    link: 'https://level-up-karshi.uz',
    tech: [
        'Django',
        'Django REST Framework',
        'Flutter',
