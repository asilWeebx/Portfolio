                ...
                <div className="pricing-content content-width">
                    ...
                    <div className="pricing-table-items">
                            ...
                            <div className="col-md-6 scroll-animation" data-animation="fade_from_left">
                                <div className="pricing-table">
                                    ...
                                    <ul className="feature-lists">
                                        ...
                                        <li>Basic API integrations (REST)</li>
                                    ...
                                    <a href="tel:+998978022008" className="theme-btn">Pick this package</a>
                                </div>
                            </div>
                            ...
                            <div className="col-md-6 scroll-animation" data-animation="fade_from_right">
                                <div className="pricing-table">
                                    ...
                                    <ul className="feature-lists">
                                        ...
                                        <li>Complex API development (WebSockets)</li>
                                        <li>Full-stack applications (Backend + Frontend)</li>
                        ...
                        <p className="info scroll-animation" data-animation="fade_from_bottom">
                            ...
                            Let's discuss and build a tailor-made package just for you. <a href="tel:+99897802008">Contact Me</a>
                        </p>
                    </div>
                </div>
            </div>
